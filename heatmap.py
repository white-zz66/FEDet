...
def get_params():
    params = {
        # 'weight': '/home/white/sharedirs/两个创新一起.pt',  # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/home/white/sharedirs/第二个创新FAM.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'weight': '/home/white/sharedirs/第一个创新772.pt',  # 现在只需要指定权重即可,不需要指定cfg
        # 'weight': '/home/white/sharedirs/baseline.pt',  # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAMPlusPlus',
        # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [10,12,14,16,18,20],
...
if __name__ == '__main__':
    ...
    model(r'/home/white/sharedirs/论文模型/test/5.jpg', 'result')