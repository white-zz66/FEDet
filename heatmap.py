...
def get_params():
    params = {
        'weight': '/root/autodl-tmp/ultralytics-main/runs/detect/train16/weights/last.pt',
        'cfg': '/root/autodl-tmp/ultralytics-main/ultralytics/cfg/models/v8/yolov8x-SPPFImproveAndFAM.yaml',
        # 'weight': '/root/autodl-tmp/ultralytics-main/yolov8x.pt',
        # 'cfg': '/root/autodl-tmp/ultralytics-main/ultralytics/cfg/models/v8/yolov8x-SPPFImproveAndFAM.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/coco/images/test2017/KK-U9R6vWlH2d__2.jpg', 'result')